...
insert into orders( ordertype, status, side, timestamp, filledquantity, price, quantity, tickersymbol, ownerid) values('LIMIT','FULFILLED','BUY','12-AUG-1995', '500','122.82', '1000', 'ATH', '3')
